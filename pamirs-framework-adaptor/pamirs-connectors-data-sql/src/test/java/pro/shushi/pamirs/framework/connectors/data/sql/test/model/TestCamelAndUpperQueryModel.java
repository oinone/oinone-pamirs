...
@Base
@Model.Static
@Model.Persistence(underCamel = true, capitalMode = true)
@Model.model("test.TestCamelAndUpperQueryModel")
@Model(displayName = "测试大写模型", summary = "测试大写模型")
public class TestCamelAndUpperQueryModel extends BaseModel {
