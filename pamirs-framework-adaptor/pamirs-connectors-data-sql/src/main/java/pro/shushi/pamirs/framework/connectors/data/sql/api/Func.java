package pro.shushi.pamirs.framework.connectors.data.sql.api;
...
public interface Func<Children, R> extends Serializable {
    ...
    default Children in(Collection<R> column, List<?>... coll) {
        return in(true, column, coll);
    }
    ...
    Children in(boolean condition, Collection<R> column, List<?>... coll);
     ...
     * @return Children
     */
    Children orderByNe(boolean condition, R column, String param);
