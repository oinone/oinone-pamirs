...
public class FileUtils {
    ...
    public static void write(String path, String content) {
        writeDirect(FileUtils.class.getClassLoader().getResource(".").getPath() + path, content);
    }

    public static void writeResource(String path, String content) {
        writeDirect(FileUtils.class.getClassLoader().getResource(path).getPath(), content);
    }
