...
欢迎访问 Oinone Pamirs，与我们一起完善 AI 驱动的企业级产品化引擎，此仓库为 Oinone 后端框架。

Oinone 是 AI 驱动的企业级产品化引擎，以低代码和无代码为载体的软件标准产品研发与敏捷交付一体化研发框架。Oinone 响应信创工程，全栈支持国产操作系统、中间件、数据库等。 Oinone 谐音 All-in-one 之意，O 代表开源，象征：一站式、敏捷响应、持续创新。
...
### 5、Aino
#### 5.1 何为 Oinone Aino（AI Innovation，谐音 I Know）
...
|--------------------------------------------------------------------------------------------------------------------------------|----------------|-----------------------------|---------------|
| ⚡ [安装与升级](https://guide.oinone.top/zh-cn/InstallOrUpgrade/)                                                                    |⚡ [📗 用户手册](https://guide.oinone.top/zh-cn/UserManual/) | 📦 pamirs-k2                | 🌟 后端元数据核心功能  |
| ⚡ [环境准备](https://guide.oinone.top/zh-cn/InstallOrUpgrade/Dev-ENV/)                                                             |⚡ [📗 研发手册](https://guide.oinone.top/zh-cn/DevManual/)| 📦 pamirs-framework         | 🌟 后端核心功能包    |
| ⚡ [社区版：源码安装](https://guide.oinone.top/zh-cn/InstallOrUpgrade/CommunityEdition/source-code-installation.html)                   | ⚡ [📗 产品白皮书](https://www.oinone.top/whitePaper)|📦 pamirs-framework-commons | 🌟 后端核心功能公共包  |
| ⚡ [企业版：快速体验：docker-full 方式安装](https://guide.oinone.top/zh-cn/InstallOrUpgrade/EnterpriseEdition/docker-full-installation.html) |⚡ [📗 最佳范式](https://guide.oinone.top/zh-cn/DevManual/R_DParadigm)| 📦 pamirs-framework-adaptor | 🌟 后端核心功能扩展包  |
| ⚡ [企业版：docker-mini 方式安装](https://guide.oinone.top/zh-cn/InstallOrUpgrade/EnterpriseEdition/docker-mini-installation.html)      | ⚡ [📗 常见解决方案](https://guide.oinone.top/zh-cn/DevManual/CommonSolutions)|📦 pamirs-spi               | 🌟 后端SPI基础功能包 |
| ⚡ [企业版：运行程序包方式安装](https://guide.oinone.top/zh-cn/InstallOrUpgrade/EnterpriseEdition/docker-full-installation.html)             |⚡ [📗 常见问题](https://guide.oinone.top/zh-cn/DevManual/FAQ)| 📦 pamirs-boot              | 🌟 后端应用启动包    |
| ⚡ [入门教程 <建议完整学习> ](https://guide.oinone.top/zh-cn/DevManual/Tutorials/)                                                        ||📦 pamirs-core              | 🌟 后端基础功能包    |
| ⚡ [调试工具](https://guide.oinone.top/zh-cn/DevManual/Tutorials/debug-tools.html)                                                  | |📦 pamirs-middleware        | 🌟 后端中间件功能包   |
|                                                                                                                                | |📦 pamirs-ux                | 🌟 后端用户体验功能包  |
