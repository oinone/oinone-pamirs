 ...
 * 根据bizId分片（无事务控制）
 */
public class SerialBaseScheduleNoTransactionTask extends AbstractLocalSerialScheduleTaskDealSingle implements IScheduleTaskDealSingle<List<ScheduleItem>> {
