...
public interface QueryByCodeAfterExtPoint<T> {

    @ExtPoint.name(queryByCode + AFTER_SUFFIX)
    @ExtPoint(displayName = "根据编码查询单条记录后置扩展点")
    default T queryByCodeAfter(T data) {
        return data;
    }
