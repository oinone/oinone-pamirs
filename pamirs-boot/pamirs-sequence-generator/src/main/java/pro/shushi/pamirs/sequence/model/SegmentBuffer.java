...
public class SegmentBuffer {
    ...
    public SegmentBuffer setKey(String key) {
        this.key = key;
        return this;
    }
    ...
    public SegmentBuffer switchPos() {
        currentPos = nextPos();
        return this;
    }
    ...
    public SegmentBuffer setInitOk(boolean initOk) {
        this.initOk = initOk;
        return this;
    }
    ...
    public SegmentBuffer setNextReady(boolean nextReady) {
    ...
    public SegmentBuffer setStep(int step) {
        this.step = step;
        return this;
    }
    ...
    public SegmentBuffer setMinStep(int minStep) {
