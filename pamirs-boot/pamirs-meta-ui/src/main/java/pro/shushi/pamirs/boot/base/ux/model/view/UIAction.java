...
public class UIAction extends UIWidget {
     ...
     */
    @XStreamAsAttribute
    @Field(displayName = "目标模块显示名称")
    private String resModuleDisplayName;
