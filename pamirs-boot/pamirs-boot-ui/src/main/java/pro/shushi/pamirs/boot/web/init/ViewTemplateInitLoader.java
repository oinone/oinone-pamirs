        ...
        for (Resource resource : resources) {
            try (InputStream is = resource.getInputStream()) {
                ...
                if (obj instanceof UIView) {
                    ...
                    view.setTitle(I18nUtils.translateView(uiView.getModel(), viewName, "title", uiView.getTitle()));
                    view.setType(uiView.getType());
                    view.setBizType(ViewBizTypeEnum.OPERATIONS_MANAGEMENT);
                    view.setSummary(I18nUtils.translateView(uiView.getModel(), viewName, "summary", uiView.getSummary()));
