package pro.shushi.pamirs.sid.impl;

import org.apache.commons.lang3.StringUtils;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import pro.shushi.pamirs.framework.common.id.UidGenerator;
...
import pro.shushi.pamirs.sid.BitsAllocator;
import pro.shushi.pamirs.sid.enmu.SidExpEnumerate;
import pro.shushi.pamirs.sid.worker.DisposableWorkerIdAssigner;
import pro.shushi.pamirs.sid.worker.WorkerIdAssigner;
...
public class DefaultUidGenerator implements UidGenerator {
     ...
     */
    protected String epochStr = "2019-11-20";
    protected long epochSeconds = TimeUnit.MILLISECONDS.toSeconds(1574179200000L);
     ...
     * Spring property
     */
    protected WorkerIdAssigner workerIdAssigner = new DisposableWorkerIdAssigner();
...
//        }
    ...
    public long getUID() throws UidGenerateException {
        try {
            ...
            throw PamirsException.construct(SidExpEnumerate.BASE_GENERATE_UNIQUE_ID_ERROR, e).errThrow();
        }
    }
    ...
    public String parseUID(long uid) {
        ...
        String thatTimeStr = DateUtils.formatDate(thatTime);
    ...
    protected synchronized long nextId() {
        ...
        // Clock moved backwards, refuse to generate uuid
        ...
        if (currentSecond == lastSecond) {
            ...
            // Exceed the max sequence, we wait the next second to generate uuid
            if (sequence == 0) {
