...
import pro.shushi.pamirs.sid.buffer.BufferPaddingExecutor;
import pro.shushi.pamirs.sid.buffer.RejectedPutBufferHandler;
import pro.shushi.pamirs.sid.buffer.RejectedTakeBufferHandler;
import pro.shushi.pamirs.sid.buffer.RingBuffer;

import java.util.ArrayList;
import java.util.List;

import static pro.shushi.pamirs.sid.enmu.SidExpEnumerate.BASE_GENERATE_UNIQUE_ID_ERROR;
 ...
 */
@SPI.Service(value = UidGeneratorFactory.CACHED_UID_GENERATOR_NAME)
public class CachedUidGenerator extends DefaultUidGenerator {
    ...
    public long getUID() {
        try {
            ...
            throw PamirsException.construct(BASE_GENERATE_UNIQUE_ID_ERROR, e).errThrow();
        }
    }
