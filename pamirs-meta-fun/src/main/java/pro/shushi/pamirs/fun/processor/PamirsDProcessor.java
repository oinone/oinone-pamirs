 ...
 * @author deng
 */
public class PamirsDProcessor extends AbstractProcessor {
                ...
                public void visitClassDef(JCTree.JCClassDecl jcClassDecl) {
                    ...
                    jcVariableDeclList.forEach(jcVariableDecl -> {
                        if(!jcVariableDecl.mods.toString().contains("static") && !jcVariableDecl.mods.toString().contains("final")){
                            ...
                            Optional.ofNullable(FunUtils.makeSetterMethodDecl(jcClassDecl, jcVariableDecl, treeMaker, names,messager)).map(_method->jcClassDecl.defs = jcClassDecl.defs.append(_method));
                            Optional.ofNullable(FunUtils.makeUnSetterMethodDecl(jcClassDecl, jcVariableDecl, treeMaker, names)).map(_method->jcClassDecl.defs = jcClassDecl.defs.append(_method));
