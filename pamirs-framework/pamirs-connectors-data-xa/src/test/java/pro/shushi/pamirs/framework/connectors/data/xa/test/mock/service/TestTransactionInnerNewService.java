 ...
 */
@Component
public class TestTransactionInnerNewService {

    @Resource
    private GenericMapper genericMapper;

    @PamirsTransactional(enableXa = true, propagation = Propagation.REQUIRES_NEW)
    public void insertMultiDsWithInnerNewSpringTransaction(DataMap ds0) {
    ...
    @PamirsTransactional(enableXa = true, propagation = Propagation.REQUIRES_NEW)
    public void insertMultiDsWithInnerNewSpringTransactionRollback(DataMap ds0) {
