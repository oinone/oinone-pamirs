 ...
 */
@Fun
public class RsqlExpressionChecker implements Checker<String>, MetaCheckConstants {

    @Function.Advanced(displayName = "校验查询条件格式", type = FunctionTypeEnum.QUERY)
    @Function.fun(checkRsqlExpression)
    @Override
