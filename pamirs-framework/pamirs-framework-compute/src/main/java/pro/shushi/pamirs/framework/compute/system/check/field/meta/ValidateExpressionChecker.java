 ...
 */
@Fun
public class ValidateExpressionChecker implements Checker<String>, MetaCheckConstants {

    @Function.Advanced(displayName = "校验规则格式", type = FunctionTypeEnum.QUERY)
    @Function.fun(checkRuleExpression)
    @Override
