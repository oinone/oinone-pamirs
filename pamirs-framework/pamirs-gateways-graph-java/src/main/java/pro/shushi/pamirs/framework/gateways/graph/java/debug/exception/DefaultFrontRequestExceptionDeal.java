 ...
 */
@Component
public class DefaultFrontRequestExceptionDeal implements FrontRequestExceptionDeal {
    ...
    public void stackTrace(DataFetcherExceptionHandlerParameters handlerParameters, DataFetcherExceptionHandlerResult result, Throwable exception, ExecutionPath path) {
        result.getErrors().add(ClientGraphQLError.build(StackTraceConstants.STACKTRACE_ROOT_EXCEPTION, ExceptionUtils.getStackTrace(ExceptionUtils.getRootCause(exception))));
    }
