 ...
 */
@Component
public class FrontRequestExceptionDeal4BizStack implements FrontRequestExceptionDeal {
    ...
    public void stackTrace(DataFetcherExceptionHandlerParameters handlerParameters, DataFetcherExceptionHandlerResult result, Throwable exception, ExecutionPath path) {
        ...
        result.getErrors().add(ClientGraphQLError.build(StackTraceConstants.STACKTRACE_BIZ_STACK, JsonUtils.toJSONString(slowLogs)));
    }
