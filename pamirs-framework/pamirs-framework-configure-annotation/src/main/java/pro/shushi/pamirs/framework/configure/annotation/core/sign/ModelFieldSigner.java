...
public class ModelFieldSigner implements ModelSigner<ModelField> {

    @Override
    public String sign(ModelField metaModelObject) {
        return metaModelObject.getModel() + CharacterConstants.SEPARATOR_DOT + metaModelObject.getField();
    }
