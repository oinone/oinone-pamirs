...
public class ModelValidateFunConverter implements ModelConverter<Map<String, ComputeDefinition>, Class> {
    ...
    @Override
    public Map<String, ComputeDefinition> convert(MetaNames names, Class source, Map<String, ComputeDefinition> computeDefinitionMap) {
        ...
        Validation validationAnnotation = AnnotationUtils.getAnnotation(source, Validation.class);
        return Spider.getDefaultExtension(ValidationProcessor.class).fetchComputeFunctionMap(computeDefinitionMap, validationAnnotation, module,
    ...
    public List<String> signs(MetaNames names, Class source) {
        ...
        for (Validation.Fun fun : ruleAnnotations) {
            ...
            String sign = ExpressionDefinition.sign(type, ModelDefinition.MODEL_MODEL, modelModel, check);
            signs.add(sign);
        }
