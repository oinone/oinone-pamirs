...
@Slf4j
@Component
public class DropTableFunctionOfModuleConverter implements ModelConverter<FunctionDefinition, Class>, ModuleFunctionConstants {
    ...
    public FunctionDefinition convert(MetaNames names, Class source, FunctionDefinition function) {
        ...
        String fun = FUN_DROP_TABLE;
        Object object= BeanDefinitionUtils.getBean(BEAN_LOGIC_SCHEMA_SERVICE);
        Method method = MethodUtils.findMethod(object.getClass(),fun, ModelDefinition.class);
