...
@Slf4j
@Component
public class BuildTableFunctionOfModuleConverter implements ModelConverter<FunctionDefinition, Class>, ModuleFunctionConstants {
    ...
    public FunctionDefinition convert(MetaNames names, Class source, FunctionDefinition function) {
        ...
        String fun = FUN_BUILD_TABLE;
        Object object = BeanDefinitionUtils.getBean(BEAN_LOGIC_SCHEMA_SERVICE);
        Method method = MethodUtils.findMethod(object.getClass(), fun, List.class, Boolean.class, Boolean.class);
        function.setBeanName(BEAN_LOGIC_SCHEMA_SERVICE);
