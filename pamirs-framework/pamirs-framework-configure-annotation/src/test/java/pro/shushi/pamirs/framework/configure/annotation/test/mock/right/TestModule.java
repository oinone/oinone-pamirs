package pro.shushi.pamirs.framework.configure.annotation.test.mock.right;
...
public class TestModule implements PamirsModule {
    ...
    public String[] packagePrefix() {
        return new String[]{"pro.shushi.pamirs.framework.configure.annotation.test.mock.right"};
    }
