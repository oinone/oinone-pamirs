...
import pro.shushi.pamirs.framework.connectors.data.tx.platform.PamirsTransactionsFactory;
...
public class MybatisPlusAutoConfiguration implements InitializingBean {
    ...
    private static final String USING_DEFAULT_XPATH_FACTORY = "pamirs.xpath.using-default-xpath-factory";

    private static final String XPATH_FACTORY_PROPERTY = XPathFactory.class.getName() + ":" + XPathFactory.DEFAULT_OBJECT_MODEL_URI;
    ...
    public SqlSessionFactory sqlSessionFactory(DataSource dataSource) throws Exception {
        ...
        factory.setTransactionFactory(new PamirsTransactionsFactory());
    ...
    private void applyConfiguration(MybatisSqlSessionFactoryBean factory) {
        ...
        if (configuration == null && !StringUtils.hasText(this.properties.getConfigLocation())) {
            configuration = new PamirsMybatisConfiguration();
        }
