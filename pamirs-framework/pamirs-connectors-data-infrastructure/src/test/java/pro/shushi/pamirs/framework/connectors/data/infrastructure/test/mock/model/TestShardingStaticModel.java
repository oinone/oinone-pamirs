...
@Base
@Model.Static
@Model.model(TestShardingStaticModel.modelModel)
@Model.Ds("ds0")
@Model(displayName = "测试模型", summary = "测试模型")
public class TestShardingStaticModel extends IdModel {

    public static final String modelModel = "test.TestShardingStaticModel";
