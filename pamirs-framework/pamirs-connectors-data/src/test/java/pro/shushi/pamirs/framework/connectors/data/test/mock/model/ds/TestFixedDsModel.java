package pro.shushi.pamirs.framework.connectors.data.test.mock.model.ds;
...
@Model.model(TestFixedDsModel.modelModel)
@Model(displayName = "测试模型", summary = "测试模型")
public class TestFixedDsModel extends IdModel {

    public static final String modelModel = "test.TestFixedDsModel";
