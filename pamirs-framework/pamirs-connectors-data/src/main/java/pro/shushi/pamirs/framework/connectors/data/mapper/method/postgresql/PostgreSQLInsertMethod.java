package pro.shushi.pamirs.framework.connectors.data.mapper.method.postgresql;
 ...
 */
@Data
public class PostgreSQLInsertMethod extends AbstractPostgreSQLMethod implements InsertMethod {
    ...
    public PostgreSQLInsertMethod(ModelConfig modelConfig) {
        super(modelConfig);
    }
