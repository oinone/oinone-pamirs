 ...
 */
@Data
public class SqlServerInsertMethod extends AbstractSqlServerMethod implements InsertMethod {
    ...
    public SqlServerInsertMethod(ModelConfig modelConfig) {
        super(modelConfig);
    }
    ...
    public String batchSqlValues() {
        return SqlScriptUtils.convertForeach(getSqlValue(), Constants.COLLECTION,
    ...
    public String onDuplicateKeyUpdate() {
        ...
        sqlScript = String.format(SqlServerScriptTemplate.ON_DUPLICATE_KEY_UPDATE, sqlScript);
