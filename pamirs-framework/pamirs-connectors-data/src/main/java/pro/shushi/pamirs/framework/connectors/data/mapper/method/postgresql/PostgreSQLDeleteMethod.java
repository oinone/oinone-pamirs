 ...
 */
@Data
public class PostgreSQLDeleteMethod extends PostgreSQLSelectMethod implements DeleteMethod {

    public PostgreSQLDeleteMethod(ModelConfig modelConfig) {
        super(modelConfig);
    }
    ...
    public String sqlDelete() {
        ...
        if (!logicDelete) {
            ...
            return PostgreSQLScriptTemplate.LOGIC_DELETE_SQL;
        }
    }
