 ...
 * @author paidaxing
 * @version 1.0.0
 * @date 2024/03/15 09:21:37
 */
@Data
public class GaussUpdateMethod extends GaussSelectMethod implements UpdateMethod {
    ...
    public GaussUpdateMethod(ModelConfig modelConfig) {
        super(modelConfig);
    }
