...
@Model.model(ModelServerActionOverview.MODEL_MODEL)
@Model(displayName = "ServerAction对比概况")
public class ModelServerActionOverview extends TransientModel {

    private static final long serialVersionUID = 4246858238262336231L;

    public static final String MODEL_MODEL = "tools.ModelServerActionOverview";
