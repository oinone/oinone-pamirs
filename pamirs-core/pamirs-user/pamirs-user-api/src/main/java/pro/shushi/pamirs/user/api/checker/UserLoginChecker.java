...
import static pro.shushi.pamirs.user.api.enmu.UserExpEnumerate.USER_LOGIN_PIC_CODE_ERROR;
import static pro.shushi.pamirs.user.api.enmu.UserExpEnumerate.USER_NEED_PIC_CODE_ERROR;
import static pro.shushi.pamirs.user.api.enmu.UserExpEnumerate.USER_REFRESH_PIC_CODE_ERROR;
