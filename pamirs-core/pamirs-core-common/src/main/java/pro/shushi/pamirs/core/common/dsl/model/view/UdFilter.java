 ...
 * @version 1.0.0
 */
@XStreamAlias(DslConstants.NODE_FILTER)
@Model(displayName = "视图字段")
public class UdFilter extends UdWidget {

    private static final long serialVersionUID = -7494579397321584695L;
    ...
    public UdFilter setProxyOptions(List<UdOption> proxyOptions) {
