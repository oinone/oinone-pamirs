...
public enum CommonExpEnumerate implements ExpBaseEnum {
    ...
    MODEL_NOT_FOUND(ERROR_TYPE.SYSTEM_ERROR, 10057009, "未找到模型字段元数据 model: {}"),
    MODEL_FIELD_NOT_FOUND(ERROR_TYPE.SYSTEM_ERROR, 10057010, "未找到模型字段元数据 model: {}, field: {}"),
    SORT_FIELD_NOT_FOUND(ERROR_TYPE.SYSTEM_ERROR, 10057011, "未找到排序字段元数据 model: {}, field: {}"),
    GROUPING_FIELD_NOT_FOUND(ERROR_TYPE.SYSTEM_ERROR, 10057012, "未找到分组字段元数据 model: {}, field: {}"),
    STATISTIC_API_NOT_FOUND(ERROR_TYPE.SYSTEM_ERROR, 10057013, "不支持的统计方式 statistic: {}"),
