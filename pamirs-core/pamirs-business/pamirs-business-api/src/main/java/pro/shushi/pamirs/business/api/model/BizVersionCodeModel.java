...
import pro.shushi.pamirs.meta.base.common.VersionCodeModel;
...
@Base
@Model.model(BizVersionCodeModel.MODEL_MODEL)
@Model.Advanced(type = ModelTypeEnum.ABSTRACT)
@Model(displayName = "带乐观锁的code业务模型", summary = "带code模型业务抽象基类")
public class BizVersionCodeModel extends VersionCodeModel implements IUserNameModel {

    public static final String MODEL_MODEL = "business.BizVersionCodeModel";
