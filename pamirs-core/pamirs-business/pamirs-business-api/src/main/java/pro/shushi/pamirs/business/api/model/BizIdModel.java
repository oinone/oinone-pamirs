...
@Base
@Model.model(BizIdModel.MODEL_MODEL)
@Model.Advanced(type = ModelTypeEnum.ABSTRACT)
@Model(displayName = "id业务模型", summary = "带id模型业务抽象基类")
public class BizIdModel extends IdModel implements IUserNameModel {

    public static final String MODEL_MODEL = "business.BizIdModel";
