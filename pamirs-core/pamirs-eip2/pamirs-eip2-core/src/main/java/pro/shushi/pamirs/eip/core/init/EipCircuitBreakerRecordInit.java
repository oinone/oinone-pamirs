...
import pro.shushi.pamirs.eip.core.task.EipCircuitBreakerRecordSyncTask;
...
public class EipCircuitBreakerRecordInit implements InstallDataInit, UpgradeDataInit {
    ...
    @Resource
    private EipCircuitBreakerRecordSyncTask circuitBreakerRecordSyncTask;
    @Resource
    private EipCircuitBreakerRuleService eipCircuitBreakerRuleService;

    @Override
    public boolean upgrade(AppLifecycleCommand command, String version, String existVersion) {
        circuitBreakerRecordSyncTask.initTask();
