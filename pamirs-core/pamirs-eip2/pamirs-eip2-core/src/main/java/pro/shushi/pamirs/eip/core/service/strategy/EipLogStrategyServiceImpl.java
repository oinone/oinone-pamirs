...
public class EipLogStrategyServiceImpl implements EipLogStrategyService {
    ...
    public EipLogStrategy ignoreFrequency(String interfaceName, InterfaceTypeEnum interfaceType) {
        ...
        EipLogStrategyEntity logStrategy = EipLogStrategyContext.getOrCreate(interfaceType, interfaceName);
        logStrategy.setIgnoreLogFrequency(true);
        BeanDefinitionUtils.getBean(EipLogStrategyService.class).refreshLogStrategy(logStrategy);
        return strategy;
    }
    ...
    public EipLogStrategy cancelIgnoreFrequency(String interfaceName, InterfaceTypeEnum interfaceType) {
        ...
        EipLogStrategyEntity logStrategy = EipLogStrategyContext.getOrCreate(interfaceType, interfaceName);
        logStrategy.setIgnoreLogFrequency(false);
        BeanDefinitionUtils.getBean(EipLogStrategyService.class).refreshLogStrategy(logStrategy);
        return strategy;
    }
