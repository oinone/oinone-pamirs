...
public enum EipExpEnumerate implements ExpBaseEnum {
    ...
    EIP_ALARM_NAME_EMPTY(ERROR_TYPE.BIZ_ERROR, 10051120, "请填写名称"),
    EIP_ALARM_NAME_DUP(ERROR_TYPE.BIZ_ERROR, 10051121, "名称重复"),
    EIP_ALARM_INTERFACE_OTHER_REL(ERROR_TYPE.BIZ_ERROR, 10051122, "集成接口重复配置规则，刷新后重试"),
