...
public enum EipExpEnumerate implements ExpBaseEnum {
    ...
    EIP_ALARM_NAME_EMPTY(ERROR_TYPE.BIZ_ERROR, 10051110, "请填写名称"),
    EIP_ALARM_NAME_DUP(ERROR_TYPE.BIZ_ERROR, 10051111, "名称重复"),
    EIP_ALARM_INTERFACE_EMPTY(ERROR_TYPE.BIZ_ERROR, 10051112, "请选择集成接口"),
    ;
