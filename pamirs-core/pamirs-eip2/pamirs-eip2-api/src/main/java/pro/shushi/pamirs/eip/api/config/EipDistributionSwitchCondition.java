 ...
 */
public class EipDistributionSwitchCondition implements Condition {
    ...
    public boolean matches(ConditionContext context, AnnotatedTypeMetadata metadata) {
        return context.getEnvironment().getProperty(EipConfigurationConstant.PAMIRS_EIP_PREFIX + ".enabled", Boolean.class, true) &&
                context.getEnvironment().getProperty(EipConfigurationConstant.PAMIRS_EIP_PREFIX + ".distribution.enabled", Boolean.class, true);
    }
}
