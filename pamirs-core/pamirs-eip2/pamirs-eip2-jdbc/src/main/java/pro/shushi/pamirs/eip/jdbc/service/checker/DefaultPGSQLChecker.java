...
import pro.shushi.pamirs.eip.jdbc.check.PostgreSQLCheckVisitor;
 ...
 */
@Component
public class DefaultPGSQLChecker extends AbstractSQLChecker implements EipSQLChecker {
    ...
    public SQLASTVisitor visitor(SQLPrepareEntity prepareEntity) {
        return new PostgreSQLCheckVisitor(prepareEntity.getPrepareParameters());
    }
