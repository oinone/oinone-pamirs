 ...
 */
@Component
public class DefaultOracleSQLChecker extends AbstractSQLChecker implements EipSQLChecker {
    ...
    public SQLASTVisitor visitor(SQLPrepareEntity prepareEntity) {
        return new OracleSQLCheckVisitor(prepareEntity.getPrepareParameters());
    }
