...
public enum SsoExpEnumerate implements ExpBaseEnum {
    ...
    SSO_INVALID_ACCESS_TOKEN_ERROR(ERROR_TYPE.BIZ_ERROR, 10041020, "无效的 ACCESS_TOKEN"),
    SSO_PAMIRS_CLIENT_NOT_ENABLED_ERROR(ERROR_TYPE.BIZ_ERROR, 10041021, "客户端未启用SSO"),
    SSO_PAMIRS_CLIENT_NOT_HOME_PAGE_URL(ERROR_TYPE.BIZ_ERROR, 10041022, "客户端未配置跳转首页");
