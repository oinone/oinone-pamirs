...
import pro.shushi.pamirs.auth.api.cache.service.AuthRoleHomepageCacheService;
...
@Component
@SPI.Service
public class AuthRoleHomepageCacheServiceImpl extends AbstractHashCacheService<Long, String, Long> implements AuthRoleHomepageCacheService {
