...
import pro.shushi.pamirs.auth.api.cache.service.AuthRoleActionByModelCacheService;
 ...
 * 角色动作权限缓存服务 - 基于模型
 *
 * @author Adamancy Zhang at 22:03 on 2024-01-10
 */
@Order
@Component
@SPI.Service
public class AuthRoleActionByModelCacheServiceImpl extends AbstractHashCacheService<ActionCacheKeyByModel, String, Long> implements AuthRoleActionByModelCacheService {
    ...
    @Override
    protected String generatorCacheKey(ActionCacheKeyByModel key) {
        return AuthConstants.AUTH_CACHE_KEY_PREFIX + key.getRoleId() + CharacterConstants.SEPARATOR_COLON +
                ...
                AuthConstants.ACTION_TYPE + CharacterConstants.SEPARATOR_COLON +
                key.getModel();
    }
}
