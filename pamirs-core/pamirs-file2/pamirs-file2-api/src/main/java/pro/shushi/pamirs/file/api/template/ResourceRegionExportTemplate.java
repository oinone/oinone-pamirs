...
public class ResourceRegionExportTemplate extends AbstractExcelExportFetchDataExtPointImpl implements ExcelTemplateInit {
    ...
    public List<ExcelWorkbookDefinition> generator() {
        return Collections.singletonList(WorkbookDefinitionBuilder.newInstance(ResourceRegionProxyModel.MODEL_MODEL, "ResourceRegionExportTemplate")
                ...
                .setDisplayName(I18nUtils.getMessage("file.template.region.title"))
                .createSheet().setName(I18nUtils.getMessage("file.template.region.sheet.country"))
                ...
                .createCell().setValue(I18nUtils.getMessage("file.template.region.header.code")).and()
                .createCell().setValue(I18nUtils.getMessage("file.template.region.header.name")).and()
                .createCell().setValue(I18nUtils.getMessage("file.template.region.header.fullName")).and()
                .createCell().setValue(I18nUtils.getMessage("file.template.region.header.exciseTax")).and()
                .createCell().setValue(I18nUtils.getMessage("file.template.region.header.longDistanceAreaCode")).and()
                .createCell().setValue(I18nUtils.getMessage("file.template.region.header.currencyCode")).and()
                .createCell().setValue(I18nUtils.getMessage("file.template.region.header.currencyName")).and()
                .createCell().setValue(I18nUtils.getMessage("file.template.region.header.currencySymbol")).and()
                .createCell().setValue(I18nUtils.getMessage("file.template.region.header.langCode")).and()
                .createCell().setValue(I18nUtils.getMessage("file.template.region.header.langName")).and()
                .createCell().setValue(I18nUtils.getMessage("file.template.region.header.countryGroupCode")).and()
                .createCell().setValue(I18nUtils.getMessage("file.template.region.header.countryGroupName")).and()
                .createCell().setValue(I18nUtils.getMessage("file.template.region.header.addrFormat")).and()
                .createCell().setValue(I18nUtils.getMessage("file.template.region.header.namePosition")).and()
                .and().and().and()


                .createSheet().setName(I18nUtils.getMessage("file.template.region.sheet.province"))
                ...
                .and()
                .createHeader().setStyleBuilder(ExcelHelper.createDefaultStyle(typeface -> typeface.setBold(Boolean.TRUE)).setHorizontalAlignment(ExcelHorizontalAlignmentEnum.CENTER))
                .createCell().setValue(I18nUtils.getMessage("file.template.region.header.sourceType")).and()
                .createCell().setValue(I18nUtils.getMessage("file.template.region.header.name")).and()
                .createCell().setValue(I18nUtils.getMessage("file.template.region.header.countryCode")).and()
                .createCell().setValue(I18nUtils.getMessage("file.template.region.header.countryName")).and()
                .and().and().and()
                .createSheet().setName(I18nUtils.getMessage("file.template.region.sheet.city"))
                ...
                .createCell().setValue(I18nUtils.getMessage("file.template.region.header.name")).and()
                .createCell().setValue(I18nUtils.getMessage("file.template.region.header.longDistanceAreaCode")).and()
                .createCell().setValue(I18nUtils.getMessage("file.template.region.header.postalCode")).and()
                .createCell().setValue(I18nUtils.getMessage("file.template.region.header.countryCode")).and()
                .createCell().setValue(I18nUtils.getMessage("file.template.region.header.countryName")).and()
                .createCell().setValue(I18nUtils.getMessage("file.template.region.header.provinceCode")).and()
                .createCell().setValue(I18nUtils.getMessage("file.template.region.header.provinceName")).and()
                .and().and().and()
                .createSheet().setName(I18nUtils.getMessage("file.template.region.sheet.district"))
                ...
                .createCell().setValue(I18nUtils.getMessage("file.template.region.header.provinceCode")).and()
                .createCell().setValue(I18nUtils.getMessage("file.template.region.header.provinceName")).and()
                .createCell().setValue(I18nUtils.getMessage("file.template.region.header.cityCode")).and()
                .createCell().setValue(I18nUtils.getMessage("file.template.region.header.cityName")).and()
                .and().and().and()
                .createSheet().setName(I18nUtils.getMessage("file.template.region.sheet.street"))
                ...
                .createCell().setValue(I18nUtils.getMessage("file.template.region.header.cityCode")).and()
                .createCell().setValue(I18nUtils.getMessage("file.template.region.header.cityName")).and()
                .createCell().setValue(I18nUtils.getMessage("file.template.region.header.districtCode")).and()
                .createCell().setValue(I18nUtils.getMessage("file.template.region.header.districtName")).and()
                .and().and().and()
                .build());
    }
