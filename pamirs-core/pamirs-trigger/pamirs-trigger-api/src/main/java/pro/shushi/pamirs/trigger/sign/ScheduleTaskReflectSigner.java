...
public class ScheduleTaskReflectSigner implements ModelReflectSigner<ScheduleTaskAction, Method> {
    ...
    public String sign(MetaNames names, Method source) {
        ...
        if (schedule == null) {
            ...
            return PamirsTenantSession.getTenant() + CharacterConstants.SEPARATOR_COLON + PamirsTenantSession.getEnv() + CharacterConstants.SEPARATOR_COLON + schedule.name();
        }
    }
