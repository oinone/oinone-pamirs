...
import static pro.shushi.pamirs.apps.api.enmu.ModuleCategoryType.BASE_SUPPORT;
import static pro.shushi.pamirs.apps.api.enmu.ModuleCategoryType.BUSINESS_GROWTH;
import static pro.shushi.pamirs.apps.api.enmu.ModuleCategoryType.OPERATION_SUPPORT;
